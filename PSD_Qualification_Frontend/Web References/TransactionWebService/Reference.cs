...
namespace PSD_Qualification_Frontend.TransactionWebService {
    ...
    public partial class TransactionWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public TransactionWebService() {
            this.Url = global::PSD_Qualification_Frontend.Properties.Settings.Default.PSD_Qualification_Frontend_TransactionWebService_TransactionWebService;
        ...
        /// <remarks/>
        public void CreateTransactionAsync(string userId, string meowId) {
            this.CreateTransactionAsync(userId, meowId, null);
        }
        
        /// <remarks/>
        public void CreateTransactionAsync(string userId, string meowId, object userState) {
            ...
            this.InvokeAsync("CreateTransaction", new object[] {
                        userId,
                        meowId}, this.CreateTransactionOperationCompleted, userState);
        }
